...
class PlayerControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.playerService = Mock(PlayerService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.playerService = Mock(PlayerService) {
            1 * save(_ as Player) >> { Player player ->
                throw new ValidationException("Invalid instance", player.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.player instanceof Player
    }
